...
/**
 * Contexto de combate que la escena expone al jugador. Desacopla al Player
 * de la GameScene: pide acciones sin conocer grupos ni físicas.
 */
...
/** Contexto que la escena expone a los enemigos (ej. shooters que disparan). */
